...
const createTaskValidation = [
    ...
    (0, express_validator_1.check)('status')
        ...
        .withMessage('Status must be one of: allTask, onGoing, inProgress, pending, collaborativeTask, done'),
    (0, express_validator_1.check)('endDate').notEmpty().withMessage('End date is required'),
];
const updateTaskValidation = [
    ...
    (0, express_validator_1.check)('status')
        ...
        .withMessage('Status must be one of: allTask,inProgress, onGoing, pending, collaborativeTask, done'),
