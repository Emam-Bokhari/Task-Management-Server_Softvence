...
const createTask = (payload, email) =>
...
const getAllTasksBySpecificUser = (email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (tasks.length === 0) {
      throw new HttpError_1.HttpError(
        404,
        'No task were found provide this user ID',
      );
    }
    return tasks;
  });
const getTaskById = (id, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.isUserExists(email);
    if (!user) {
      throw new HttpError_1.HttpError(404, 'User not found');
...
const updateTaskById = (id, payload, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedTask = yield task_model_1.Task.findOneAndUpdate(
...
const updateTaskStatusById = (id, status, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // check if user exists
    const user = yield user_model_1.User.isUserExists(email);
    if (!user) throw new HttpError_1.HttpError(404, 'User not found');
    // update task status
    const updatedTaskStatus = yield task_model_1.Task.findOneAndUpdate(
...
const deleteTaskById = (id, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deletedTask = yield task_model_1.Task.findOneAndUpdate(
      { _id: id },
      { isDeleted: true },
      { new: true },
    );
